...
Cs  = 1835;                        % Damping constant suspension   [N.s/m]
L0_s    = 1.1;                     % Spring relaxed suspension     [m] 1.1
...
tmax = 2;
time = 0:dt:tmax;
vel = 0.4;                         % Longitudinal speed of the car [m/s]

%% Road

l = 0.8;                            %anomaly = l/2[m] (min 0.2)
h = 0.3;                            %anomaly height [m]
...
function plotDamper(L0_2,h1,z_s,z_u,i,x_inst)
    ...
    rodLowerPct = 0.2;      % Length lower rod percentage of total gap 
